...
This will get you a dacpac at 'bin/Debug/net10.0/Issue3342.dacpac'

## EFCPT from a dacpac

```bash
efcpt 'bin/Debug/net10.0/Issue3342.dacpac' mssql
```
...
Notice that Issue3342Context.cs is updated and TableTwo is removed
