...
namespace DockerPlayground.Models
{
    public partial interface IDockerPlaygroundContextProcedures
    {
        ...
        Task<List<StoGetSomeDataDirectTypeMatrixResult>?> StoGetSomeDataDirectTypeMatrixAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
